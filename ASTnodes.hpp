...
class AST_cmd_brightness
{
	...
	virtual ~AST_cmd_brightness() { delete expression; }
...
class AST_cmd_load_background_image
{
	...
	public:
	virtual int accept(Visitor &v) { return v.visit(this); }
	AST_cmd_load_background_image(AST_exp_string_literal *s) { string_literal = s; }
	virtual ~AST_cmd_load_background_image() { delete string_literal; }
};
class AST_cmd_load_music
{
	friend class Visitor;
	...
	public:
	virtual int accept(Visitor &v) { return v.visit(this); }
	AST_cmd_load_music(AST_exp_string_literal *s) { string_literal = s; }
	virtual ~AST_cmd_load_music() { delete string_literal; }
};
class AST_cmd_play_music
{
	friend class Visitor;
	...
	public:
	virtual int accept(Visitor &v) { return v.visit(this); }
	AST_cmd_play_music(AST_exp_string_literal *s) { string_literal = s; }
	~AST_cmd_play_music() { delete strinrg_literal; }
};
class AST_cmd_wait
{
	friend class Visitor;
	...
	public:
	virtual int accept(Visitor &v) { return v.visit(this); }
	AST_cmd_wait(AST_expression *e) { expression = e; }
	~AST_cmd_wait() { delete expression; }
};
class AST_cmd_fade_in_brightness
{
	friend class Visitor;
	AST_expression *exp_degree;
	AST_expression *exp_millisec;
	public:
	virtual int accept(Visitor &v) { return v.visit(this); }
	virtual ~AST_cmd_fade_in_brightness() { delete exp_degree; delete exp_millisec; }
...
class AST_cmd_fade_out_music
{
	...
	public:
	virtual int accept(Visitor &v) { return v.visit(this); }
	virtual ~AST_cmd_fade_out_music() { delete exp_degree; delete exp_millisec; }
