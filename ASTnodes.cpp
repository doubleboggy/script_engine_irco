...
{
	// todo: need to implement on driver side
	return driver->set_blightness(cmd_brightness->expression->accept(*this));
}
// ----
int Visitor::visit(AST_cmd_load_background_image *cmd_load_background_image)
{
	return driver->load_background_image(cmd_load_background_image->string_literal->val_string);
}
// ----
int Visitor::visit(AST_cmd_load_music *cmd_load_music)
{
	return driver->load_music(cmd_load_music->string_literal->val_string);
}
// ----
int Visitor::visit(AST_cmd_play_music *cmd_play_music)
{
	return driver->play_music(cmd_play_music->string_literal->val_string);
}
// ----
int Visitor::visit(AST_cmd_wait *cmd_wait)
{
	return driver->wait_millisecond(cmd_wait->expression->accept(*this));
}
// ----
int Visitor::visit(AST_cmd_fade_in_brightness *cmd_fade_in_brightness)
{
	return driver->fade_in_brightness(cmd_fade_in_brightness->exp_degree->accept(*this),
									  cmd_fade_in_brightness->exp_millisec->accept(*this));
}
// ----
int Visitor::visit(AST_cmd_fade_out_music *cmd_fade_out_music)
{
	return driver->cmd_fade_out_music(cmd_fade_in_brightness->exp_degree->accept(*this),
									  cmd_fade_in_brightness->exp_millisec->accept(*this));
}
// ----
